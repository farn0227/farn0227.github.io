    ...
    <div className="home-default">
      ...
      <div className="   m-auto pt-32">
        <img
          src={pers}
          data-aos="fade-right"
          className="object- rounded-xl md:w-4/6 px-5 md:px-0 m-auto"
        ></img>
      </div>
      <div className="md:w-4/6 px-5 md:px-0 m-auto mt-10 flex flex-col gap-5">
        ...
        <p className="text-littletext">
          {" "}
          stylish salon dedicated to providing top-notch haircuts and grooming
          services for men. Our experienced barbers specialize in classic and
          contemporary cuts, and we use only the finest products to ensure that
          you leave our shop looking and feeling your best. We offer a wide
          range of services, including haircuts, shaves, beard trims, and color
          services. Our barbers are skilled in all types of hair, and can create
          a look that's tailored to your individual style. We also offer a
          variety of grooming products, including pomades, shaving creams, and
          colognes, so you can maintain your new look at home.
        </p>
        <div className="flex flex-col gap-5">
          ...
          <a
            href=""
            className="text-button  font-bold bg-white rounded-full w-48 text-sm text-center px-10 py-2 "
          >
            Visit Site
          </a>
        </div>
      ...
      <div className=" mt-24 pb-24">
        <h1 className="text-littletittle w-4/5 m-auto text-5xl font-bold">
          Preview
        </h1>
        <img
          src={pers}
